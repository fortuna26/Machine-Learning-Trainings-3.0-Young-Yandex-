...
| [HW_5](https://github.com/fortuna26/Machine-Learning-Trainings-3.0-Young-Yandex-/blob/main/HW_5/hw_05_NEO-TOKIO.ipynb)) | In this assignment, we solved a binary classification task on tabular data. After performing EDA, we trained and evaluated two models: Logistic Regression as a baseline and CatBoostClassifier for improved accuracy. | Python, Pandas, NumPy, Matplotlib, Seaborn, Scikit-learn, CatBoost |
